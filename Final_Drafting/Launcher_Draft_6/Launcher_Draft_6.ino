...
{  
  ...
  else if(targeting)                                    // Firing State /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  {
    ...
    {   
      ...
      {
        // TX targeting packet to target                Targeting packet = T|[Seconds to hit - 3]
        char radiopacket[6] = "T|   ";                  // Build targeting packet literal
        ...
        { 
          if (rf95.recv(buf, &len))           // RX successfully within timeout (RX read into buf)
          {
            ...
            // Decide Hit or Miss
            if(incomingPacket[0] == 'M')      // Hit - check first char of received message, will either be 'H' or 'M'        (Note: Needs '' to denote CHAR here, do not use "")
            {
  ...
  else if(calibrating)                                    // Calibrating State //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  {
    ...
    {      
      ...
      if(caliPackets <= 0)
      {
        // All LEDs flash light green - they will only be held this way for as long as the tones below last (short time), then will switch back to normal when returning to idle state
