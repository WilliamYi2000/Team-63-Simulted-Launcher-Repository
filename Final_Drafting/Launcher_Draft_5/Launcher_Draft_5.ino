...
bool calibrationPressedAndReleased = true;       // Makes sure we have released calibration button before trying to press it again
...
{  
  if(idle)                                                // Base State: IDLE ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  {
    ...
    else if((digitalRead(caliButton)==HIGH) && !calibrationPressedAndReleased)
    {
  ...
  else if(calibrating)                                    // Calibrating State //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  {
    ...
    lightLEDsTwoColors(caliPackets-1, 255, 255, 0, 0, 0, 255);        // Blue, Yellow  
    //lightLEDsTwoColors(caliNumber-1, 0, 0, 255, 255, 255, 0);        // Blue, Yellow  (reciprocal direction -> counts backwards)
    ...
    {      
      ...
      { 
        ...
        else                                // RX partially recieved (Recieve failure case)
        {
          ...
          // Calibration packets must be contiguous
    ...
    else if((digitalRead(caliButton)==LOW) && calibrationPressedAndReleased)           // If calibration button is pressed and trigger is NOT pressed (trigger takes precedence) we will go back to idle state (Emergency leave calibration state)
    {
    ...
    if(digitalRead(triggerButton)==LOW)                                // Trigger released during calibration
    {
      // Calibration packets must be contiguous
      caliPackets = caliPacketsRequired;       // Reset req number of cali packets
      caliNumber = 0;                          // Reset variable tracking number of received calibration packets
